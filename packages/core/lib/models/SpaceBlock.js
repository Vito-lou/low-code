...
class SpaceBlock {
    ...
    get snapLine() {
        ...
        const distance = (0, shared_1.calcDistanceOfSnapLineToEdges)(line, this.helper.dragNodesEdgeLines);
        return new SnapLine_1.SnapLine(this.helper, Object.assign(Object.assign({}, line), { distance, type: 'space-block' }));
    }
}

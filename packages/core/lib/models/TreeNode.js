...
class TreeNode {
    ...
    get designerProps() {
        const behaviors = registry_1.GlobalRegistry.getDesignerBehaviors(this);
    ...
    static clone(nodes = []) {
        ...
        (0, shared_1.each)(filterNestedNode, (node) => {
        ...
        (0, shared_1.each)(groups, (nodes, parentId) => {
            const lastNode = lastGroupNode[parentId];
            let insertPoint = lastNode;
            (0, shared_1.each)(nodes, (node) => {
                var _a, _b;

...
import { requestIdle, globalThisPolyfill } from '@lowcode/shared';
    ...
    function onInputHandler(event) {
        ...
        if (node) {
            ...
            const handler = () => {
                ...
                Path.setIn(node.props, this.getAttribute(engine.props.contentEditableAttrName), target === null || target === void 0 ? void 0 : target.textContent);
                requestIdle(() => {

import { calcExtendsLineSegmentOfRect, calcDistanceOfSnapLineToEdges, LineSegment, Rect, } from '@lowcode/shared';
import { SnapLine } from './SnapLine';
import { TransformHelper } from './TransformHelper';
export class SpaceBlock {
    constructor(helper, box) {
        this.helper = helper;
    ...
    get id() {
        var _a;
        return ((_a = this._id) !== null && _a !== void 0 ? _a : `${this.rect.x}-${this.rect.y}-${this.rect.width}-${this.rect.height}`);
    }
    get next() {
    ...
    get snapLine() {
        ...
        return new SnapLine(this.helper, Object.assign(Object.assign({}, line), { distance, type: 'space-block' }));
    }
}

import { Point, calcEdgeLinesOfRect, calcBoundingRect, calcSpaceBlockOfRect, calcElementTranslate, calcDistanceOfSnapLineToEdges, Rect, isEqualRect, isLineSegment, calcClosestEdges, calcCombineSnapLineSegment, } from '@lowcode/shared';
...
export class TransformHelper {
            ...
            const add = (line) => {
                ...
                if (distance < TransformHelper.threshold) {
                    if (this.snapping && distance !== 0)
                        return;
                    const snapLine = new SnapLine(this, Object.assign(Object.assign({}, combined), { distance }));
    ...
    calcAroundSpaceBlocks(dragNodesRect) {
        ...
        this.eachViewportNodes((refer, referRect) => {
            ...
            if (origin) {
                const spaceBlock = new SpaceBlock(this, Object.assign({ refer }, origin));
    ...
    addRulerSnapLine(line) {
        ...
        if (!this.findRulerSnapLine(line.id)) {
            this.rulerSnapLines.push(new SnapLine(this, Object.assign(Object.assign({}, line), { type: 'ruler' })));
        }
    }
